...
export const EXAMPLE_ORG_ID = env['NG_APP_EXAMPLE_ORG_ID'] || DEFAULT_EXAMPLE_ORG_ID;
export const QRATI_SCRIPT_URL = env['NG_APP_QRATI_SCRIPT_URL'] || DEFAULT_QRATI_SCRIPT_URL;
